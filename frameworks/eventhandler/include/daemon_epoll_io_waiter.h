...
#ifndef BASE_EVENTHANDLER_FRAMEWORKS_EVENTHANDLER_INCLUDE_DAEMON_IO_WAITER_H
#define BASE_EVENTHANDLER_FRAMEWORKS_EVENTHANDLER_INCLUDE_DAEMON_IO_WAITER_H
...
class DaemonIoWaiter final : public IoWaiter {
public:
    DaemonIoWaiter();
    ~DaemonIoWaiter() final;
    static DaemonIoWaiter& GetInstance();
    DISALLOW_COPY_AND_MOVE(DaemonIoWaiter);
...
#endif  // #ifndef BASE_EVENTHANDLER_FRAMEWORKS_EVENTHANDLER_INCLUDE_DAEMON_IO_WAITER_H
